...
> **Kör listan i appen, inte här.** `hardat-test.html` har samma innehåll men
> gör jobbet åt testaren: ett tryck på raden = "gjort och blev som beskrivet",
> knappen **AVVEK** öppnar snabbval för vad som hände i stället plus ett
> fritextfält. **Kopiera rapport** ger en färdig felrapport med enhet,
> appversion, härdat-status och alla avvikelser — testaren behöver inte veta
> vad en buggrapport ska innehålla.
>
> Sidan ligger i service workerns cache och fungerar därför i flygplansläge,
> när den här filen inte gör det. Den saknar medvetet rad i menyn; öppna via
> URL: `7srapport.com/hardat-test.html`. Den här filen är källan för
> innehållet och för utfallsloggen nedan.
