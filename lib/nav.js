...
(function (global) {
  ...
  const GROUPS = [
    { id: 'RAPPORTERA',  label: 'Rapportera',      emoji: '📡', subtitle: 'Skriv och skicka läge uppåt',
      blurb: 'Här bygger och skickar du lägesrapporter, postinstruktioner, order, väder och skadeläge uppåt till din chef — börja här när något ska meldas.' },
    ...
    { id: 'KARTA',       label: 'Karta & terräng', emoji: '🗺️', subtitle: 'Rita, planera och bedöm i terräng',
      blurb: 'Alla kartverktyg samlade: rita minering och sensorer, dra korridorer du kan exportera, och bedöm riskzon vid drönarfall.' },
    { id: 'FORBERED',    label: 'Förbered gruppen',emoji: '✅', subtitle: 'Order, vakt, säkerhet och mått',
      blurb: 'Allt du fixar innan ni går ut: patrullchef-checklista, vaktschema, säkerhetsgenomgång, linjedragning, mått och farligt gods.' },
    { id: 'LARA',        label: 'Plugga & slå upp',emoji: '📚', subtitle: 'Öva, repetera och hitta fakta',
      blurb: 'Öva med flashcards och prov, slå snabbt upp symboler, ramsor, handtecken och sjukvård — och logga dina skjutpass.' },
  ...
  const ITEMS = [
    // RAPPORTERA — bygg och skicka rapporter uppåt till chef/TAK.
    { id: '7S',       label: '7S',       href: 'index.html',    group: 'RAPPORTERA', icon: 'binoculars' },
    { id: 'OBSLOSA',  label: 'OBSLÖSA',  href: 'obslosa.html',  group: 'RAPPORTERA', icon: 'eye' },
    ...
    { id: 'EOBUSARE', label: 'EOBUSARE', href: 'eobusare.html', group: 'RAPPORTERA', icon: 'clipboard' },
    { id: 'OBO',      label: 'OBO',      href: 'obo.html',      group: 'RAPPORTERA', icon: 'clipboard', badge: 'BETA' },
    { id: 'VADER',    label: 'VÄDER',    href: 'vader.html',    group: 'RAPPORTERA', icon: 'stormCloud' },
    { id: 'PATL',     label: 'PATL',     href: 'patl.html',     group: 'RAPPORTERA', icon: 'stretcher' },
    ...
    // KARTA & TERRÄNG — kartverktyg + terräng-/riskbedömning.
    ...
    // FÖRBERED GRUPPEN — checklistor, schema, mått innan utgående.
    ...
    { id: 'SAEKR',    label: 'SÄKR',     href: 'saekr.html',      group: 'FORBERED', icon: 'shieldOk' },
    { id: 'LINJE',    label: 'LINJE',    href: 'linje.html',      group: 'FORBERED', icon: 'line' },
    { id: 'MATT',     label: 'MÅTT',     href: 'matt.html',       group: 'FORBERED', icon: 'tape' },
    { id: 'HJALM24',  label: 'Hjälm 24', href: 'hjalm24.html',    group: 'FORBERED', icon: 'helmet' },
    { id: 'UN',       label: 'UN',       href: 'un.html',         group: 'FORBERED', icon: 'folder' },

    // PLUGGA & SLÅ UPP — flashcards, referens-uppslag, skyttelogg.
    ...
    { id: 'FG',         label: 'FG',         href: 'fg.html',                group: 'LARA', icon: 'flag' },
    { id: 'FORKORT',    label: 'FÖRKORT',    href: 'forkort.html',           group: 'LARA', icon: 'type' },
    { id: 'RA763',      label: 'RA763',      href: 'ra763.html',             group: 'LARA', icon: 'radio' },
    { id: 'SIGSKYDD',   label: 'SIGSKYDD',   href: 'sigskydd.html',          group: 'LARA', icon: 'lock' },
    { id: 'SYMBOL',     label: 'SYMBOL',     href: 'symbol.html',            group: 'LARA', icon: 'boxX' },
    ...
    { id: 'SKYTTE',     label: 'SKYTTE',     href: 'skyttebok.html',         group: 'LARA', icon: 'humanTarget' },
