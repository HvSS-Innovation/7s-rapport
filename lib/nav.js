...
(function (global) {
  ...
  const GROUPS = [
    ...
    { id: 'ADMIN',       label: 'Admin',           emoji: '📋', subtitle: 'Mått, materiel, skytte och sjukvård',
      blurb: 'Diverse fält- och förvaltningsuppgifter: kroppsmått, hjälmstorlek (Stridshjälm 24), patientliggare med triage, skyttelogg och övningsplanering för instruktörer (beta).' },
  ...
  const ITEMS = [
    ...
    { id: 'OVNINGSPASS', label: 'Övningspass',     href: 'ovningspass.html', group: 'ADMIN', icon: 'calendar', badge: 'BETA' },
