...
(function (global) {
  ...
  const GROUPS = [
    ...
    { id: 'ADMIN',       label: 'Admin',           emoji: '📋', subtitle: 'Mått, materiel, skytte och sjukvård',
      blurb: 'Diverse fält- och förvaltningsuppgifter: kroppsmått, hjälmstorlek (Stridshjälm 24), patientliggare med triage, skyttelogg och övningsplanering för instruktörer (kommer snart).' },
  ...
  const ITEMS = [
    ...
    { id: 'FG',         label: 'Farligt gods',            href: 'fg.html',                group: 'LARA', icon: 'flag' },
    { id: 'FORKORT',    label: 'Förkortningar',           href: 'forkort.html',           group: 'LARA', icon: 'type' },
    { id: 'RA763',      label: 'RA763',                   href: 'ra763.html',             group: 'LARA', icon: 'radio' },
    { id: 'SIGSKYDD',   label: 'Signalskydd',             href: 'sigskydd.html',          group: 'LARA', icon: 'lock' },
    { id: 'SAEKR',      label: 'SÄKR',                    href: 'saekr.html',             group: 'LARA', icon: 'shieldOk' },
    { id: 'LINJE',      label: 'Linjebyggnad',            href: 'linje.html',             group: 'LARA', icon: 'line' },
    ...
    { id: 'PATL',        label: 'Patientliggare',  href: 'patl.html',        group: 'ADMIN', icon: 'stretcher' },
    { id: 'SKYTTE',      label: 'Skytte',          href: 'skyttebok.html',   group: 'ADMIN', icon: 'humanTarget' },
    { id: 'OVNINGSPASS', label: 'Övningspass',     href: 'ovningspass.html', group: 'ADMIN', icon: 'calendar', badge: 'SNART' },
  ...
  // Kärnan: 7S (observation) + FORS/PEDARS (melda läge/materiel).
  // Grupprubrikerna Observation/Rapportera följer med automatiskt.
  const SLIM_IDS = ['7S', 'FORS', 'PEDARS'];
