...
(function (global) {
  ...
  const ITEMS = [
    ...
    { id: 'UPK',        label: 'UPK',        href: 'upk.html',               group: 'HIDDEN', icon: 'compass' }
  ];

  // Slim-läge (default): bara dessa items visas — en avskalad snabbmeny.
  // "Visa hela menyn"-knappen i footern fäller ut den gamla fullständiga menyn.
  ...
  function buildDrawer() {
    ...
    if (slim) {
      // Slim-läge: en tydligt färgad knapp som fäller ut hela (gamla) menyn.
      ...
      // Full meny: behåll "Visa dolda"-toggeln + en diskret väg tillbaka till slim.
