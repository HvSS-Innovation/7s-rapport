        ...
        function styleIdFor(kind, color, dashed, fillColor, fillOpacity, iconType) {
            ...
            if (kind === 'point') {
                if (iconType && iconTypes.has(iconType)) {
                    ...
                    // OPSEC: här låg tidigare en <href> till
                    // maps.google.com/mapfiles/... Filen är avsedd att lämna
                    // enheten, så referensen blev ett fjärranrop hos MOTTAGAREN
                    // när ATAK eller Google Earth öppnade den — utanför allt vi
                    // kan spärra, och en signal om att filen just öppnades.
                    // Ingen ikon alls är bättre än en som ringer hem; punkten
                    // ritas med Google Earths standardikon.
                    styles.push(
                        '    <Style id="' + id + '">' +
