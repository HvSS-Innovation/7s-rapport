...
### ✅ Åtgärdade
*   **Härdat läge: falska "sjöar" (blå kilar) fixade** *(2026-07-29, v0.3.18)*
    *   Rotorsak: topo-flavorns PolygonSymbolizer canvas-fyllde vattendrags-LineStrings i Protomaps water-lager (fanns latent även i Sverige). Geometrifilter + vattendrag som blå linjer.
*   **Varningsraden leder in i Härdat läge** *(2026-07-29, v0.3.18)*
    *   "Slå på Härdat läge"-knapp i varningsraden (alla kartor/modaler), grön bekräftelse i påläge, ärlig statusrad ("z 9 — Härdat: Estland").
*   **Kartstil-valet synliggjort** *(2026-07-29, v0.3.18)*
    *   "Kartstil"-rad i offline-väljarens footer (fungerar före aktivering, även från rapportsidorna) + etikett vid minkarta/sensorskiss-dropdownen.
*   **Grannlands-panel i väljarkartan** *(2026-07-29, v0.3.18)*
    *   FI/EE/LV/LT som klickbara ytor bredvid Sverige (Natural Earth-geometri, samma hover/kö/status som landskapen). DK/NO ansluts via verktyg/gen-countries-geo.js när filerna finns.
*   **Ljust läge: kontrastgenomgång** *(2026-07-29, v0.3.18)*
    *   Playwright-audit över 26 tema-sidor, 0 AA-brott efter fix (surface-tokens, accent-dim/muted, vit-text-lista, per-komponent-overrides).
*   **Sensorskiss: riktiga symboler** *(2026-07-29, v0.3.18)*
    *   CIM/PIR/KAMERA/UMRA enligt prototyperna i stab/Ny mapp/ (stjärna + armar/pärlslingor, riktbara); CCTV/DSLR/HUND egna former i samma språk.
